...
public interface IRadialMenuItem
{
    ...
    /// </remarks>
    public Rectangle? TintRectangle => null;
    ...
    ///     <see cref="MenuItemActivationResult.Delayed" /> outcome and the actual action being skipped.
    /// </param>
...
public interface IRadialMenuPage
{
    ...
    /// <summary>
    ///     Index of the selected <see cref="IRadialMenuItem" /> in the <see cref="Items" /> list, or <c>-1</c> if no
    ///     selection.
    /// </summary>
...
public enum MenuItemActivationResult
{
    ...
    ///     (e.g. inedible materials or tools like axe or hoe), or the requested action was
    ///     <see cref="MenuItemAction.Select" />,
    ...
    ///         other effect that would cause <see cref="StardewModdingAPI.Context.CanPlayerMove" /> to evaluate to
    ///         <c>false</c>.
    ///     </para>
    ///     <para>
    ...
    ///     implement their own selection behavior, but if it is used, then the corresponding <see cref="IRadialMenuPage" />
    ///     must
