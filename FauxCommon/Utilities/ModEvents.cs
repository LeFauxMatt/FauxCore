...
internal static class ModEvents
{
    ...
    ///     of an event.
    /// </remarks>
    public static void Publish<TEventArgs>(TEventArgs eventArgs) => EventManager.Publish(eventArgs);
    ...
    public static void Subscribe<TEventArgs>(Action<TEventArgs> handler) => EventManager.Subscribe(handler);

    /// <summary>Unsubscribes an event handler from an event.</summary>
    /// <param name="handler">The event handler to unsubscribe.</param>
    /// <typeparam name="TEventArgs">The type of the event arguments.</typeparam>
    public static void Unsubscribe<TEventArgs>(Action<TEventArgs> handler) => EventManager.Unsubscribe(handler);
}
